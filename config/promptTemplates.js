...
const PROMPT_TEMPLATES = {
  '대화':
    ...
    "사용자가 질문했을 때는 그 질문을 감정이나 맥락과 연결해 의미를 재해석하고, 감동을 줄 수 있도록 따뜻하게 답변해줘.",
...
const SUMMARY_PROMPT = {
  '대화': {
    ...
    user: "다음 대화 내용을 아래 형식에 맞춰 **일기처럼 1인칭 말투로** 정리해줘:\n\n" +
          ...
          "2. 사람: 대화에 참여한 실제 사람 단 1명만 적어줘.\n" +
          "3. 장소: 대화가 이루어진 실제 단 1개의 장소만 적어줘.\n" +
          "4. 내용:\n" +
          "대화 키워드: 핵심 키워드를 나열해줘.\n" +
          "흐름: 대화의 전개를 3~4문장으로 요약해줘.\n" +
          "기억에 남는 대화: 기억에 남는 문장 1~2개를 실제 대화 내용을 그대로 적어줘.\n" +
          "인사이트: 이 대화를 통해 내가 얻은 통찰이나 교훈을 정리해줘.\n\n" +
          "5. 감정: 대화를 하며 느낀 감정을 키워드 단 1개로 정리해줘.\n" +
          "6. 카테고리: 이 대화가 속하는 주제 카테고리를 단 1개로 정해줘.\n"
  },
  ...
  '이벤트': {
    ...
    user: "다음 이벤트 내용을 아래 형식에 맞춰 **일기처럼 1인칭 말투로** 정리해줘:\n\n" +
          ...
          "2. 사람: 함께한 사람이나 관련된 인물 단 1명만 적어줘.\n" +
          "3. 장소: 그 일이 일어난 실제 장소를 단 1개만 적어줘.\n" +
          "4. 내용:\n" +
          "시간: 언제 일어난 일이었는지 알려줘.\n" +
          "요약: 어떤 일이 있었는지를 3~4문장으로 정리해줘.\n" +
          "느낀 점: 그때 내가 느꼈던 감정이나 떠오른 생각들을 정리해줘.\n\n" +
          "5. 감정: 그 순간의 감정을 키워드 단 1개로 정리해줘.\n" +
          "6. 카테고리: 이 이벤트의 주제를 기반으로 적절한 카테고리를 단 1개로 정해줘.\n"
  },
  ...
  '생각': {
    ...
    user: "다음 생각 내용을 아래 형식에 맞춰 **일기처럼 1인칭 말투로** 정리해줘:\n\n" +
          ...
          "2. 사람: 이 생각과 관련된 인물이 있다면 단 1명만 적어줘.\n" +
          "3. 장소: 이 생각을 한 실제 장소를 단 1개만 적어줘.\n" +
          "4. 내용:\n" +
          "생각의 발단 : 왜 이런 생각을 하게 되었는지 설명해줘.\n" +
          "사고 흐름: 내 생각이 어떻게 전개되었는지를 3~4문장으로 정리해줘.\n" +
          "인사이트: 이 생각을 통해 얻은 통찰이나 배운 점을 적어줘.\n\n" +
          "5. 감정: 이 생각과 관련된 감정을 키워드 단 1개로 정리해줘.\n" +
          "6. 카테고리: 이 생각이 속하는 주제 카테고리를 단 1개로 정해줘.\n"
  },
  ...
  'default': {
    ...
    user: "다음 내용을 아래 형식에 맞춰 **일기처럼 1인칭 말투로** 정리해줘:\n\n" +
          ...
          "5. 감정: 느낀 감정을 키워드로 단 1개로 적어줘.\n" +
          "6. 카테고리: 해당 기록을 적절한 주제로 분류해서 단 1개로 정해줘.\n"
  }
};
